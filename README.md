...
1. Explain the difference between `RDBMS` and `SQL`.
  ...
  RDBMS = relational database management system. It is management software for databases.

  SQL = structures query language. Used to communicate with database systems.


1. Why do tables need a `primary key`?

   To reference an item without conflict and quickly.
...
1. What do we need in order to have a _many to many_ relationship between two tables.
   ...
   Two foreign keys are needed within the table. They will reference two separate tables.
